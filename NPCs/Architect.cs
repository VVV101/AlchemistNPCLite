        ...
        */
        ...
        public override void AddShops()
        {
			...
			shop = new NPCShop(Type, Candle)
				...
				.Add(new Item(2650) { shopCustomPrice = 500 })
			...
			shop = new NPCShop(Type, Lamp)
				...
				.Add(new Item(2091) { shopCustomPrice = 500 })
			...
			shop = new NPCShop(Type, Lantern)
				...
				.Add(new Item(2043) { shopCustomPrice = 500 })
			...
			shop = new NPCShop(Type, Chandelier)
				...
				.Add(new Item(2064) { shopCustomPrice = 1200 })
			...
			shop = new NPCShop(Type, Candelabra)
				...
				.Add(new Item(2103) { shopCustomPrice = 500 })
