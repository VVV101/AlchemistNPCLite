        ...
        */
        ...
        public override void AddShops()
        {
			...
			shop = new NPCShop(Type, Candle)
				.Add(new Item(105) { shopCustomPrice = 3500 })
				.Add(new Item(713) { shopCustomPrice = 5250 })
				...
				.Add(new Item(2052) { shopCustomPrice = 500 }, Condition.DownedGolem)
			...
			shop = new NPCShop(Type, Lamp)
				.Add(new Item(341) { shopCustomPrice = 3000 })
				...
				.Add(new Item(2089) { shopCustomPrice = 500 }, Condition.DownedGolem)
				...
				.Add(new Item(2130) { shopCustomPrice = 1000 })
			...
			shop = new NPCShop(Type, Lantern)
				...
				.Add(new Item(2036) { shopCustomPrice = 1500 })
				...
				.Add(new Item(2041) { shopCustomPrice = 500 }, Condition.DownedGolem)
			...
			shop = new NPCShop(Type, Chandelier)
				...
				.Add(new Item(2062) { shopCustomPrice = 1200 }, Condition.DownedGolem)
				...
				.Add(new Item(2655) { shopCustomPrice = 1500 })
			...
			shop = new NPCShop(Type, Candelabra)
				...
				.Add(new Item(714) { shopCustomPrice = 30000 })
				...
				.Add(new Item(2096) { shopCustomPrice = 1500 })
				...
				.Add(new Item(2101) { shopCustomPrice = 500 }, Condition.DownedGolem)
