            ...
            if (Shop4)
            {
                if (NPC.downedBoss3 && Main.expertMode)
                {
                    if (Calamity != null)
                    {
                        ...
                        {
                            shop.item[nextSlot].SetDefaults(ModLoader.GetMod("CalamityMod").ItemType("StormWeaverBag"));
                            shop.item[nextSlot].shopCustomPrice = 6500000;
                            nextSlot++;
                        }
                        if ((bool)Calamity.Call("Downed", "ceaselessvoid"))
                        {
                            shop.item[nextSlot].SetDefaults(ModLoader.GetMod("CalamityMod").ItemType("CeaselessVoidBag"));
                            shop.item[nextSlot].shopCustomPrice = 7000000;
                            nextSlot++;
                        }
                        if ((bool)Calamity.Call("Downed", "signus"))
                        {
                            shop.item[nextSlot].SetDefaults(ModLoader.GetMod("CalamityMod").ItemType("SignusBag"));
                            shop.item[nextSlot].shopCustomPrice = 7000000;
                            nextSlot++;
                        }
                        if ((bool)Calamity.Call("Downed", "polterghast"))
